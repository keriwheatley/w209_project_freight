...
class Shipment(models.Model):
    ...
    foreign_orig = models.IntegerField(null=True)
    foreign_dest = models.IntegerField(null=True)
    domestic_orig = models.IntegerField(null=True)
    domestic_state_orig = models.CharField(max_length=100, blank=True)
    domestic_dest = models.IntegerField(null=True)
