  ...
  var imports = [];
  var lookup = [];
  d3.csv("static/data/summed_data_new.csv", function(error, data){
    d3.csv("static/data/zero_data.csv", function(error, default_data){
      d3.csv("static/data/region_colors.csv", function(error, region_data){
        if (error) {
          console.log(error);
          return error;}
  ...
  var category_range = [];
  d3.csv("static/data/category_range.csv", function(error, data){
        if (error) {
          console.log(error);
          return error;}
        category_range = data;
